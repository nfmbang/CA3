...
public class SettingsTest {
    ...
    public void testGetDEV_DBConnection(){
        ...
        assertEquals(String.format("jdbc:mysql://206.189.50.100:3306/%s",dbName), Settings.getDEV_DBConnection());
    }
    ...
    public void testGetTEST_DBConnection(){
        ...
        assertEquals(String.format("jdbc:mysql://206.189.50.100:3306/%s",dbName), Settings.getTEST_DBConnection());
    }
